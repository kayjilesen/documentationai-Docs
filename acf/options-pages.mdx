...
Er zijn twee gangbare opzetten:

<Tabs>
  <Tab title="Enkele pagina" icon="file-text">
    | Pagina | Menu slug | Beschrijving |
    |--------|-----------|-------------|
    | **Theme Settings** | `theme-settings` | Parent (redirect: `false`) |

    Alle instellingen staan op één pagina. Geschikt voor kleinere projecten met beperkte opties.
  </Tab>
  <Tab title="Met subpagina's" icon="layers">
    | Pagina | Menu slug | Beschrijving |
    |--------|-----------|-------------|
    ...
    | Tracking | `theme-settings-tracking` | Scripts en tracking codes |

    Instellingen worden opgesplitst in subpagina's voor overzicht. Geschikt voor grotere projecten.
  </Tab>
</Tabs>
