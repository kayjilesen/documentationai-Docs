...
<Tabs>
  <Tab title="PerfectFinish" icon="layout">
    19 layouts beschikbaar:

    | Layout | Beschrijving | Max |
    |--------|-------------|-----|
    | `hero` | Hero sectie met video/afbeelding | 1 |
    | `text-image` | Tekst naast afbeelding | - |
    | `text-services` | Tekst met diensten grid | 1 |
    | `call-to-action` | CTA blok | - |
    | `reviews` | Klantbeoordelingen | 1 |
    | `projecten-cases` | Portfolio showcase | 1 |
    | `veelgestelde-vragen` | FAQ accordeon | 1 |
    | `info-cards` | Informatiekaarten grid | - |
    | `highlights` | Highlights sectie | 1 |
    | `content-usps` | USP's met content | 1 |
    | `proces` | Processtappen | 1 |
    | `certificeringen` | Certificaten tonen | 1 |
    | `route` | Route/locatie info | 1 |
    | `waar` | Waar-sectie | 1 |
    | `waarom` | Waarom-sectie | 1 |
    | `uitdagingen` | Uitdagingen tonen | 1 |
    | `vacatures` | Vacatures listing | 1 |
    | `werken-bij` | Werken-bij sectie | 1 |
  </Tab>
  <Tab title="Vullingsmedia" icon="layout">
    10 layouts beschikbaar:

    | Layout | Beschrijving | Max |
    |--------|-------------|-----|
    | `hero` | Hero met video en CTA | 1 |
    | `text-image` | Tekst naast afbeelding | - |
    | `cta` | Call-to-action blok | 1 |
    | `diensten` | Diensten overzicht | 1 |
    | `over` | Over-ons sectie | 1 |
    | `cijfers` | Statistieken/cijfers | 1 |
    | `logos` | Logo carousel | 1 |
    | `podcasts` | Podcast listing | 1 |
