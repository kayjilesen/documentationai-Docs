...
|-----|------------|
| `case` | Ja — `/cases/` |
| `event` | Ja — `/events/` single (pagebuilder) óf externe link; voedt de "Upcoming events"-kaart in het Actualiteiten-blok |
...
<Callout kind="info">
  Details van de Events-opzet (velden, redirect, events-kaart, dark/light) staan bij [Project: Effecty](client-projects/effecty) — de functionaliteit komt volledig uit het gedeelde parent.
</Callout>
