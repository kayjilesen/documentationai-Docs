...
Nieuwe blocks: zie [Pagebuilder](/acf/pagebuilder) → nieuw block, en de conventies in `CLAUDE.md` van het theme.
...
- **WordPress admin (productie)**: [hoexsystems.nl/beheer](https://hoexsystems.nl/beheer) (Defender Mask Login)
- **Lokaal**: `https://hoexsystems.local/wp-admin` (of `/beheer` als Defender lokaal ook gemaskeerd is)
