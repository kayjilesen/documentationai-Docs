...
Gebruik op productie altijd **Remote Backup** met deze defaults (zie ook [Standaard Instellingen](/hosting/standaard-instellingen)):
...
| Admin URL | Altijd **`/beheer`** via [Defender Mask Login](/hosting/standaard-instellingen) |
...
<Columns cols={2}>
  <Card title="Standaard Instellingen" icon="settings" href="/hosting/standaard-instellingen">
    Plugin-presets (Defender, Smush, Hummingbird) en /beheer.
  </Card>
