---
title: "Nieuw pagebuilder-block"
description: "Stap-voor-stap een nieuw ACF Flexible Content-block toevoegen (PHP, CSS, JS, JSON)."
---
...
<Callout kind="tip">
  Naast deze standaard blocks kunnen er per project specifieke blocks worden aangemaakt (bijv. kennisbank, podcasts, pricing). Zie de betreffende klantproject-pagina voor details.
</Callout>
