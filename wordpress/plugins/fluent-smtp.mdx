...
- [ ] Maileroo primair: `noreply@klantdomein.nl`, DNS records gezet
- [ ] Keys via `FLUENTMAIL_SMTP_*` in `wp-config.php` (niet in DB)
- [ ] Amazon SES backup: `…@kayjilesen.dev`, regio **Stockholm**
- [ ] Keys via `FLUENTMAIL_AWS_*` in `wp-config.php`
- [ ] Routing: 1 = Maileroo, 2 = SES backup; logging **1 jaar**
- [ ] Testmail connection 1 én 2 ontvangen
- [ ] Pushover gekoppeld + testalert ontvangen
