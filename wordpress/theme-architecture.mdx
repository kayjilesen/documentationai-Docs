...
<Callout kind="info" title="Eerst de fundamenten?">
  Nog nieuw met WordPress zelf? Lees [Database](/wordpress/database), [Bestanden](/wordpress/bestanden) en [Configuratie](/wordpress/configuratie) voordat je in de theme-structuur duikt.
</Callout>
